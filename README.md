...
## Android Folder Custom Changes
- react-native-vector-icons: Create a Folder for fonts in android/app/src/main/assets/fonts and put required fonts

- Change BackGround Color
Add in strings.xml: 
 <color name="background">#384862</color>
 Add in Styles.xml: <item name="android:windowBackground">@color/background</item>
